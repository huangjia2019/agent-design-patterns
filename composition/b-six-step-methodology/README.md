...
> Lecture **09-02** · pattern · Composition × —
> [中文 README](README.zh-CN.md)

## Status

Placeholder. Runnable code and engineering slice arrive when lecture 09-02
...
The pattern's working title is **Six-Step Methodology** (Chinese: 六步选型法).
